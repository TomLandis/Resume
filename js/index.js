...
var App = function (_React$Component5) {
  ...
  App.prototype._addRec = function _addRec() {
    ...
    if (item == "" || inside == "" || inside == undefined || item == undefined) {
      alert("The Cook is only as good as the instructions he is given!!!");
      return;
    } else {
      var newRec = { name: item, inIt: inside };
      ...
      React.createElement(
        ...
        reci.map(function (data) {
          return React.createElement(
            ...
            React.createElement(
              "div",
              { className: "card-header", role: "tab", id: data.inIt },
              React.createElement(
                "p",
                { className: "mb-0" },
                React.createElement(
